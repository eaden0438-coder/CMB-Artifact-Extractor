...
ax.axvline(x=L_CRIT_HARDWARE, color='#ff003c', linestyle='-', linewidth=2, label=f'Absolute Theoretical Threshold ($\ell_c = {L_CRIT_HARDWARE:.0f}$)')
ax.axhline(y=0, color='#555555', linestyle='--', linewidth=1, zorder=0)

ax.set_title("Verdict IX: Strict Geometric Zero-Parameter Blind Test", fontweight='bold', color='white')
